...
let fileLinkRequest = FileLinkRequest(linkId: 123, access: FileShare(), expirationDate: Date(), title: "title_example", _internal: false, primary: true, denyDownload: false, password: "password_example") // FileLinkRequest | The file external link parameters.
 ...
 **fromDate** | **Date** | The start date of the history. | [optional] 
 **toDate** | **Date** | The end date of the history. | [optional] 
...
let fromDate = Date() // Date | The start date of the history. (optional)
let toDate = Date() // Date | The end date of the history. (optional)
...
------------- | ------------- | ------------- | -------------
 **fileId** | **Int** | File ID | 
 **accessRequestKeyDto** | [**[AccessRequestKeyDto]**](AccessRequestKeyDto.md) | Collection of encryption key data for users with access to the file | [optional] 
...
let fileId = 987 // Int | File ID
let accessRequestKeyDto = [AccessRequestKeyDto(userId: 123, publicKeyId: 123, privateKeyEnc: "privateKeyEnc_example")] // [AccessRequestKeyDto] | Collection of encryption key data for users with access to the file (optional)
