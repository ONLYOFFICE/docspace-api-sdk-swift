...
**files** | [AiFileEntryBaseDto] | The list of files of the file operation. | [optional] 
**folders** | [AiFileEntryBaseDto] | The list of folders of the file operation. | [optional] 
