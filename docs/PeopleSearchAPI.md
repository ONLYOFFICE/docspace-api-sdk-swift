...
let excludeShared = true // Bool | Specifies whether to exclude the account sharing settings from the response. (optional)
let includeShared = true // Bool | Specifies whether to include the account sharing settings in the response. (optional)
let invitedByMe = true // Bool | Specifies whether the user is invited by the current user or not. (optional)
...
let isAdministrator = true // Bool | Specifies if the user is an administrator or not. (optional)
...
let withoutGroup = true // Bool | Specifies whether the user should be a member of a group or not. (optional)
let excludeGroup = true // Bool | Specifies whether the user should be a member of the group with the specified ID. (optional)
let invitedByMe = true // Bool | Specifies whether the user is invited by the current user or not. (optional)
let inviterId = 987 // UUID | The inviter ID. (optional)
...
let employeeStatus = EmployeeStatus() // EmployeeStatus | The user status. (optional)
let activationStatus = EmployeeActivationStatus() // EmployeeActivationStatus | The user activation status. (optional)
let excludeShared = true // Bool | Specifies whether to exclude the user sharing settings or not. (optional)
let includeShared = true // Bool | Specifies whether to include the user sharing settings or not. (optional)
let invitedByMe = true // Bool | Specifies whether the user was invited by the current user or not. (optional)
let inviterId = 987 // UUID | The inviter ID. (optional)
