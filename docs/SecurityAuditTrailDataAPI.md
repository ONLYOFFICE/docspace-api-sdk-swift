 ...
 **from** | **Date** | The starting date and time for filtering audit events. | [optional] 
 **to** | **Date** | The ending date and time for filtering audit events. | [optional] 
...
let from = Date() // Date | The starting date and time for filtering audit events. (optional)
let to = Date() // Date | The ending date and time for filtering audit events. (optional)
