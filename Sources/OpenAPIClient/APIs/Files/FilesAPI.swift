...
open class {{{{x-classname}}}} {
    ...
    /**
     ...
     - parameter fileId: (path) The form the action applies to. Send the same value as the `formId` of the request body, which is the one the handler reads.      - parameter manageFormFillingDtoInteger: (body)  (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: Void
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    ...
    /**
     ...
     - parameter fileId: (path) The form the role mapping belongs to. Send the same value as the `formId` of the request body, which is the one the handler reads.      - parameter saveFormRoleMappingDtoInteger: (body)  (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: Void
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    ...
    /**
     ...
     - parameter fileId: (path) File ID      - parameter accessRequestKeyDto: (body) Collection of encryption key data for users with access to the file (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: Void
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    ...
    /**
     ...
     - parameter accessRequestKeyDto: (body) Collection of encryption key data for users with access to the file (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<Void> 
     */
