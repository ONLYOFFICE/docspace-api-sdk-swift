...
open class {{{{x-classname}}}} {
    ...
    /**
     ...
     - parameter id: (path) The file ID.      - parameter securityInfoSimpleRequestDto: (body) The parameters of the security information simple request. 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: FileShareArrayWrapper
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    ...
    /**
     ...
     - parameter id: (path) The folder ID.      - parameter securityInfoSimpleRequestDto: (body) The parameters of the security information simple request. 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: FileShareArrayWrapper
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
