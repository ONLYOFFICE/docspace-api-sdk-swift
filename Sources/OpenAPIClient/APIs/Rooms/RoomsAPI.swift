...
var fields: String?
    ...
    /**
     ...
     - parameter privacyFilter: (query) The filter by room privacy (None - 0, Private - 1, NotPrivate - 2). When omitted, all rooms are returned. (optional)
     ...
     */
    open class func getRoomsFolderWithRequestBuilder(type: [RoomType]? = nil, subjectId: UUID? = nil, subjectOwnerId: UUID? = nil, searchArea: SearchArea? = nil, withoutTags: Bool? = nil, tags: String? = nil, excludeSubject: Bool? = nil, provider: ProviderFilter? = nil, quotaFilter: QuotaFilter? = nil, storageFilter: StorageFilter? = nil, privacyFilter: RoomPrivacyFilter? = nil, count: Int? = nil, startIndex: Int? = nil, sortBy: String? = nil, sortOrder: SortOrder? = nil, filterValue: String? = nil, groupId: Int? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<FolderContentIntegerWrapper> {
        let localVariablePath = "/api/2.0/files/rooms"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
    ...
    /**
     ...
     - parameter tagName2: (path) The tag being checked. Send the same value as the `tagName` query parameter, which is the one the handler reads.      - parameter tagName: (query) Represents the name of a tag (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: BooleanWrapper
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
