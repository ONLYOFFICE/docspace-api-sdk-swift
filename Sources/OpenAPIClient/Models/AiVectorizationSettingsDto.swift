...
public struct AiVectorizationSettingsDto: Sendable, Codable, Hashable {

    /** The type of embedding provider configured for document vectorization. */
    public var type: AiEmbeddingProviderType?
    /** Indicates whether the embedding provider API key needs to be reconfigured. */
    public var needReset: Bool?

    public init(type: AiEmbeddingProviderType? = nil, needReset: Bool? = nil) {
        self.type = type
