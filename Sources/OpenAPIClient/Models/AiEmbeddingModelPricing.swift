...
public struct AiEmbeddingModelPricing: Sendable, Codable, Hashable {
    ...
    public var price: AiEmbeddingPrice

    public init(id: String?, alias: String? = nil, ownedBy: String? = nil, provider: String? = nil, link: String? = nil, price: AiEmbeddingPrice) {
        self.id = id
        self.alias = alias
...
extension AiEmbeddingModelPricing: Identifiable {}
