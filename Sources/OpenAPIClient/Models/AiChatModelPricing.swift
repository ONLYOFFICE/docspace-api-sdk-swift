...
public struct AiChatModelPricing: Sendable, Codable, Hashable {
    ...
    public init(id: String?, alias: String? = nil, ownedBy: String? = nil, provider: String? = nil, link: String? = nil, price: AiChatPrice) {
        self.id = id
        self.alias = alias
...
extension AiChatModelPricing: Identifiable {}
