...
public struct AiOpenAIStreamChunk: Sendable, Codable, Hashable {
    ...
    public init(id: String, object: Object, created: Double, model: String, choices: [AiOpenAIChunkChoice], error: AiOpenAIStreamErrorError) {
        self.id = id
        self.object = object
...
extension AiOpenAIStreamChunk: Identifiable {}
