...
public struct FileEntryDtoIntegerAllOfSecurity: Sendable, Codable, Hashable {
    ...
    public var analyzeResponses: Bool?
    public var canUseAi: Bool?
    public var historyExport: Bool?

    public init(read: Bool? = nil, comment: Bool? = nil, fillForms: Bool? = nil, review: Bool? = nil, create: Bool? = nil, createFrom: Bool? = nil, edit: Bool? = nil, delete: Bool? = nil, customFilter: Bool? = nil, editRoom: Bool? = nil, rename: Bool? = nil, readHistory: Bool? = nil, lock: Bool? = nil, editHistory: Bool? = nil, copyTo: Bool? = nil, copy: Bool? = nil, moveTo: Bool? = nil, move: Bool? = nil, pin: Bool? = nil, mute: Bool? = nil, editAccess: Bool? = nil, duplicate: Bool? = nil, submitToFormGallery: Bool? = nil, download: Bool? = nil, convert: Bool? = nil, copySharedLink: Bool? = nil, readLinks: Bool? = nil, reconnect: Bool? = nil, createRoomFrom: Bool? = nil, copyLink: Bool? = nil, embed: Bool? = nil, changeOwner: Bool? = nil, indexExport: Bool? = nil, startFilling: Bool? = nil, fillingStatus: Bool? = nil, resetFilling: Bool? = nil, stopFilling: Bool? = nil, openForm: Bool? = nil, editInternal: Bool? = nil, editExpiration: Bool? = nil, vectorization: Bool? = nil, askAi: Bool? = nil, useChat: Bool? = nil, updateXlsx: Bool? = nil, analyzeResponses: Bool? = nil, canUseAi: Bool? = nil, historyExport: Bool? = nil) {
        self.read = read
        ...
        self.historyExport = historyExport
    }
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case analyzeResponses = "AnalyzeResponses"
        case canUseAi = "CanUseAi"
        case historyExport = "HistoryExport"
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(analyzeResponses, forKey: .analyzeResponses)
        try container.encodeIfPresent(canUseAi, forKey: .canUseAi)
        try container.encodeIfPresent(historyExport, forKey: .historyExport)
    }
}
