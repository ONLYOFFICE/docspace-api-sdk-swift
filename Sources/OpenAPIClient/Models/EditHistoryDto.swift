...
public struct EditHistoryDto: Sendable, Codable, Hashable {
    ...
    public init(id: Int? = nil, key: String? = nil, version: Int? = nil, versionGroup: Int? = nil, user: EditHistoryAuthor? = nil, created: Date? = nil, changesHistory: String? = nil, changes: [EditHistoryChangesWrapper]? = nil, serverVersion: String? = nil) {
        self.id = id
        self.key = key
