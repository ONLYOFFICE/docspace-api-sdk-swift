...
public struct FileShareLink: Sendable, Codable, Hashable {
    ...
    public init(id: UUID? = nil, title: String? = nil, shareLink: String? = nil, expirationDate: Date? = nil, linkType: LinkType? = nil, password: String? = nil, denyDownload: Bool? = nil, isExpired: Bool? = nil, primary: Bool? = nil, _internal: Bool? = nil, requestToken: String? = nil, maxUseCount: Int? = nil, currentUseCount: Int? = nil) {
        self.id = id
        self.title = title
