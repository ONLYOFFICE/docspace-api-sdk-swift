...
public struct AiFolderContentDtoInteger: Sendable, Codable, Hashable {
    ...
    public var current: AiFolderDtoInteger?
    ...
    public init(files: [AiFileEntryBaseDto]? = nil, folders: [AiFileEntryBaseDto]? = nil, current: AiFolderDtoInteger? = nil, pathParts: JSONValue?, startIndex: Int? = nil, count: Int? = nil, total: Int, new: Int? = nil) {
        self.files = files
