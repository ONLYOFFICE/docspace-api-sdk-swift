...
public struct MemberBaseRequestDto: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(password: String? = nil, passwordHash: String? = nil, email: String? = nil, encEmail: String? = nil) {
