...
public struct AuditEventDto: Sendable, Codable, Hashable {
    ...
    public init(id: Int? = nil, date: Date? = nil, user: String? = nil, userId: UUID? = nil, action: String? = nil, actionId: MessageAction? = nil, ip: String? = nil, country: String? = nil, city: String? = nil, browser: String? = nil, platform: String? = nil, page: String? = nil, actionType: ActionType? = nil, product: ProductType? = nil, location: LocationType? = nil, target: [String]? = nil, entries: [EntryType]? = nil, context: String? = nil) {
        self.id = id
        self.date = date
        self.user = user
        self.userId = userId
