...
public struct LoginEventDto: Sendable, Codable, Hashable {
    ...
    public init(id: Int? = nil, date: Date? = nil, user: String? = nil, userId: UUID? = nil, login: String? = nil, action: String? = nil, actionId: MessageAction? = nil, ip: String? = nil, country: String? = nil, city: String? = nil, browser: String? = nil, platform: String? = nil, page: String? = nil) {
        self.id = id
        self.date = date
        self.user = user
        self.userId = userId
