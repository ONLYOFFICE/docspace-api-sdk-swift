...
public struct FolderLinkRequest: Sendable, Codable, Hashable {
    ...
    public init(linkId: UUID? = nil, access: FileShare? = nil, expirationDate: Date? = nil, title: String? = nil, password: String? = nil, denyDownload: Bool? = nil, _internal: Bool? = nil, primary: Bool? = nil) {
        self.linkId = linkId
        self.access = access
