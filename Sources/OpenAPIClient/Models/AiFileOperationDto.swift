...
public struct AiFileOperationDto: Sendable, Codable, Hashable {

    /** The file operation ID. */
    public var id: String?
    /** The file operation type. */
    public var operation: AiFileOperationType
    ...
    public var status: AiDistributedTaskStatus?

    public init(id: String?, operation: AiFileOperationType, progress: Int, error: String?, processed: String?, finished: Bool, url: String? = nil, files: [AiFileEntryBaseDto]? = nil, folders: [AiFileEntryBaseDto]? = nil, status: AiDistributedTaskStatus? = nil) {
        self.id = id
...
extension AiFileOperationDto: Identifiable {}
