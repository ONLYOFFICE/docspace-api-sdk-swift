...
public struct Quota: Sendable, Codable, Hashable {
    ...
    public init(id: Int? = nil, quantity: Int? = nil, wallet: Bool? = nil, dueDate: Date? = nil, nextQuantity: Int? = nil, additional: Bool? = nil, nextQuota: Int? = nil, state: QuotaState? = nil) {
        self.id = id
