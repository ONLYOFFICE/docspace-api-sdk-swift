...
public struct AiAiApproveToolCallRequest: Sendable, Codable, Hashable {
    ...
    public init(result: JSONValue?, allowAlways: Bool? = nil, threadId: String, messageId: String, idx: Double, message: AiThreadMessageLike, actionArgs: AiAiActionArgs? = nil, entityId: String? = nil, profileId: String? = nil) {
        self.result = result
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(allowAlways, forKey: .allowAlways)
