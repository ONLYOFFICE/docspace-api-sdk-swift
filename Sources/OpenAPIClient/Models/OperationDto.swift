...
public struct OperationDto: Sendable, Codable, Hashable {
    ...
    public init(date: Date? = nil, service: String? = nil, description: String? = nil, details: String? = nil, serviceUnit: String? = nil, quantity: Int? = nil, currency: String? = nil, credit: Double? = nil, debit: Double? = nil, participantName: String? = nil, participantDisplayName: String? = nil, agentId: String? = nil, agentTitle: String? = nil, type: OperationType? = nil) {
        self.date = date
