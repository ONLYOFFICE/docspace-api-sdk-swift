...
public struct RoomLinkRequest: Sendable, Codable, Hashable {
    ...
    public init(linkId: UUID? = nil, access: FileShare? = nil, expirationDate: Date? = nil, _internal: Bool? = nil, title: String? = nil, linkType: LinkType? = nil, password: String? = nil, denyDownload: Bool? = nil, maxUseCount: Int? = nil, currentUseCount: Int? = nil) {
        self.linkId = linkId
        self.access = access
