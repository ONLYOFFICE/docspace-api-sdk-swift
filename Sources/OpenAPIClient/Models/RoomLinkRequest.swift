...
public struct RoomLinkRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(linkId: UUID? = nil, access: FileShare? = nil, expirationDate: ApiDateTime? = nil, _internal: Bool? = nil, title: String? = nil, linkType: LinkType? = nil, password: String? = nil, denyDownload: Bool? = nil) {
        self.linkId = linkId
        self.access = access
