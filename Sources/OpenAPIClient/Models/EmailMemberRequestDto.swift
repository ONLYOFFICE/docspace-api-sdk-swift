...
public struct EmailMemberRequestDto: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(email: String, recaptchaType: RecaptchaType? = nil, recaptchaResponse: String? = nil) {
        self.email = email
