...
public struct AiAiRegenerateStreamRequest: Sendable, Codable, Hashable {
    ...
    public init(threadId: String, actionArgs: AiAiActionArgs? = nil, entityId: String? = nil, profileId: String? = nil) {
